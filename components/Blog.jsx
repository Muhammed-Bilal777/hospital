...
import img1 from "../src/assets/images/blog1.jpg";
import img2 from "../src/assets/images/blog2.jpg";
import img3 from "../src/assets/images/blog3.jpg";
import img4 from "../src/assets/images/blog4.jpg";
import img5 from "../src/assets/images/blog5.jpg";
import img6 from "../src/assets/images/blog6.jpg";
      ...
      <div className=" flex flex-col items-center lg:flex-row justify-between">
        <div>
          ...
          <p className=" mt-2 text-center lg:text-start">
            Age-related wear and tear, leading to degeneration of the cervical
            spine, including the discs and joints
          </p>
        </div>
